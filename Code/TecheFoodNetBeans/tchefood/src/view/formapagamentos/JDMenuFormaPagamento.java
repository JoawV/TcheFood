 ...
 * @author Vaio
 */
public class JDMenuFormaPagamento extends javax.swing.JDialog {

    /**
     * Creates new form jdMenuPedido
     */
    public JDMenuFormaPagamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setTitle("Menu de Formas de Pagamento");
    ...
    private void jbCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbCadastrarActionPerformed
       this.dispose();
        jdCadastrarFormaPagamento jCadastrarFormaPagamento = new jdCadastrarFormaPagamento(null, true);
        jCadastrarFormaPagamento.setVisible(true);
    ...
    private void jbGerenciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGerenciarActionPerformed
        this.dispose();
        jdGerenciarPagamento gerenciarPagamento = new jdGerenciarPagamento(null, true);
        gerenciarPagamento.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDMenuFormaPagamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDMenuFormaPagamento dialog = new JDMenuFormaPagamento(new javax.swing.JFrame(), true);
