 ...
 * @author Aluno TDS
 */
public class jdMenuCategoriaP extends javax.swing.JDialog {

    /**
     * Creates new form jdConsultarCategoriaP
     */
    public jdMenuCategoriaP(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jbCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbCadastrarActionPerformed
        ...
        jdCadastrarCategoriaP cadastrar = new jdCadastrarCategoriaP(null, true);
    ...
    private void jbGerenciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGerenciarActionPerformed
        ...
        jdGerenciarCategoriaP gerenciar = new jdGerenciarCategoriaP(null, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdMenuCategoriaP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdMenuCategoriaP dialog = new jdMenuCategoriaP(new javax.swing.JFrame(), true);
