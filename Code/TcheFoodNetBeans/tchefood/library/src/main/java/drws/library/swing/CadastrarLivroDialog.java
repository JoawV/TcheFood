 ...
 * @author drws
 */
public class CadastrarLivroDialog extends javax.swing.JDialog {
    private BancoDados bancoDados;
    /**
     * Creates new form CadastroAutorDialog
     */
    public CadastrarLivroDialog(java.awt.Frame parent, boolean modal, BancoDados bancoDados) {
        super(parent, modal);
        this.bancoDados = bancoDados;
        initComponents();
        this.loadAutores();
        String codigo = String.valueOf(this.bancoDados.getBiblioteca().getCodigoLivro());
    ...
    private void buttonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSalvarActionPerformed
        if(this.isEverythingOk()) {
            ...
            this.bancoDados.getBiblioteca().cadastrarLivro(livro);
            this.limparTela();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarLivroDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
