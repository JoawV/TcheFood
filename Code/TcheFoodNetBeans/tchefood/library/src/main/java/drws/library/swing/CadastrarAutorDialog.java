 ...
 * @author drws
 */
public class CadastrarAutorDialog extends javax.swing.JDialog {
    private BancoDados bancoDados;
    /**
     * Creates new form CadastroAutorDialog
     */
    public CadastrarAutorDialog(java.awt.Frame parent, boolean modal, BancoDados bancoDados) {
        super(parent, modal);
        this.bancoDados = bancoDados;
        initComponents();
        String codigo = String.valueOf(this.bancoDados.getAutores().size() + 1);
    ...
    private void buttonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSalvarActionPerformed
        if(isEverythingOK()) {
            ...
            this.bancoDados.cadastrarAutor(autor);
            this.limparTela();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarAutorDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
