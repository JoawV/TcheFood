 ...
 * @author drws
 */
public class LeitoresFrame extends JFrame {
    private BancoDados bancoDados;
    /**
     * Creates new form AcervoFrame
     */
    public LeitoresFrame(BancoDados bancoDados) {
        this.bancoDados = bancoDados;
        initComponents();
        this.loadAutores();
        this.textFieldTitulo.requestFocus();
        //initTable();
        tableCatalogo.setModel(initTable());
    }
    ...
    private void initComponents() {
        ...
        tableCatalogo.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Título", "Autor", "Gênero", "Preço"
            }
        ) {
        ...
        tableCatalogo.setShowGrid(true);
        jScrollPane1.setViewportView(tableCatalogo);
        tableCatalogo.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        if (tableCatalogo.getColumnModel().getColumnCount() > 0) {
            tableCatalogo.getColumnModel().getColumn(0).setPreferredWidth(20);
            tableCatalogo.getColumnModel().getColumn(4).setPreferredWidth(20);
        }
    ...
    private void buttonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditarActionPerformed
        int linha = tableCatalogo.getSelectedRow();
        
        if(linha != -1) {
            Object codigo = tableCatalogo.getValueAt(linha, 0);
            int indexLivro = this.bancoDados.getLoja().getIndexLivroPeloCodigo((int) codigo);
    ...
    private TableModel initTable() {
        return new LivroVendaTableModel(bancoDados.getLoja().getLivros());
    }
    ...
    public void limparTela() {
        ...
        this.tableCatalogo.clearSelection();
    }
    ...
    private void filtrar() {
        ...
        LivroVendaTableModel tableModel = new LivroVendaTableModel(bancoDados.getLoja().filtrarLivros(titulo, genero, indexAutor));
        tableCatalogo.setModel(tableModel);
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LeitoresFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
